/*
 * @Author: your name
 * @Date: 2017-07-19 20:43:40
 * @LastEditTime: 2020-03-12 16:14:08
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /vue-lottery-turntable-master/src/components/lottery/dial.js
 */
...
class LotteryDial extends Events {
  ...
  setResult (index, wheelDeg) {
    // 得到中奖结果 index:中奖奖区下标
    const singleAngle = 360 / this.options.areaNumber // 单个奖区角度值
    let endAngle = (index + 1) * singleAngle // 随机得出结果在扇区内的角度
    console.log(wheelDeg, endAngle);
    ...
    this._targetAngle = endAngle + 4 * 360
  }
